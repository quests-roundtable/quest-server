...
public class StoryDeck extends Deck {
        ...
        private static List<Card> generateCards() {
                ...
                // cards.add(new TournamentCard("Tournament_01", "Tournament At Camelot", "3
                // bonus Shields", 3));
                // cards.add(new TournamentCard("Tournament_02", "Tournament At Orkney", "2
                // bonus Shields", 2));
                // cards.add(new TournamentCard("Tournament_03", "Tournament At Tintagel", "1
                // bonus Shields", 1));
                // cards.add(new TournamentCard("Tournament_04", "Tournament At York", "0 bonus
                // Shields", 0));
