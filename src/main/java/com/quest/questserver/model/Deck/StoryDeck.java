...
public class StoryDeck extends Deck {
    ...
    private static List<Card> generateCards(){
        ...
        // Create Event cards
        cards.add(new EventCard("Event_01", "Chivalrous Deed", "Player(s) with both lowest rank and least amount of shields, receives 3 shields."));
        cards.add(new EventCard("Event_02", "Court Called to Camelot", "All Allies in play must be discarded."));
        cards.add(new EventCard("Event_02", "Court Called to Camelot", "All Allies in play must be discarded."));
        cards.add(new EventCard("Event_03", "King's Call to Arms", "The highest ranked player(s) must place 1 weapon in the discard pile. If unable to do so, 2 Foe Cards must be discard."));
        cards.add(new EventCard("Event_04", "King's Recognition", "The next player(s) to complete a Quest will receive 2 extra shields."));
        cards.add(new EventCard("Event_04", "King's Recognition", "The next player(s) to complete a Quest will receive 2 extra shields."));
        cards.add(new EventCard("Event_05", "Plague", "Drawer loses 2 shields if possible."));
        cards.add(new EventCard("Event_06", "Pox", "All players except the player drawing this card lose 1 Shield."));
        cards.add(new EventCard("Event_07", "Prosperity Throughout the Realm", "All players may immediately draw 2 Adventure Cards."));
        cards.add(new EventCard("Event_08", "Queen's Favor", "The lowest ranked player(s) immediately receives 2 Adventure Cards."));
        cards.add(new EventCard("Event_08", "Queen's Favor", "The lowest ranked player(s) immediately receives 2 Adventure Cards."));
